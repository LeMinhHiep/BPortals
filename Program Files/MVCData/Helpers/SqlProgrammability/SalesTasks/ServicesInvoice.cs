...
namespace MVCData.Helpers.SqlProgrammability.SalesTasks
{
    public class ServicesInvoice
    {
        ...
        private void SalesInvoicePrint()
        {
            ...
            queryString = queryString + "       SELECT          SalesInvoices.SalesInvoiceID, IIF(SalesInvoices.SalesInvoiceID = @SalesInvoiceID, SalesInvoices.EntryDate, NULL) AS EntryDate, GetDate() AS PrintedDate, SalesInvoices.Reference, IIF(SalesInvoices.SalesInvoiceID = @SalesInvoiceID, SalesInvoices.Reference, NULL) AS SVReference, SalesInvoices.VATInvoiceNo, SalesInvoices.VATInvoiceDate, SalesInvoices.VATInvoiceSeries, " + "\r\n";
            ...
            queryString = queryString + "                       EntireTerritories ON Customers.TerritoryID = EntireTerritories.TerritoryID LEFT JOIN " + "\r\n";
            queryString = queryString + "                       Employees ON SalesInvoices.SalesInvoiceID = @SalesInvoiceID AND SalesInvoices.EmployeeID = Employees.EmployeeID LEFT JOIN " + "\r\n";
            queryString = queryString + "                       AspNetUsers ON SalesInvoices.SalesInvoiceID = @SalesInvoiceID AND SalesInvoices.PreparedPersonID = AspNetUsers.UserID LEFT JOIN " + "\r\n";
            queryString = queryString + "                       ServiceContracts ON SalesInvoices.ServiceContractID = ServiceContracts.ServiceContractID LEFT JOIN " + "\r\n";
