...
namespace MVCData.Helpers.SqlProgrammability.SalesTasks
{
    public class ServicesInvoice
    {
        ...
        private void SalesInvoicePrint()
        {
            ...
            queryString = queryString + "       SELECT          SalesInvoices.SalesInvoiceID, SalesInvoices.EntryDate, GetDate() AS PrintedDate, SalesInvoices.Reference, SalesInvoices.VATInvoiceNo, SalesInvoices.VATInvoiceDate, SalesInvoices.VATInvoiceSeries, AspNetUsers.FirstName + ' ' + AspNetUsers.LastName AS PreparedPersonName, Employees.Name AS EmployeeName, " + "\r\n";
            queryString = queryString + "                       SalesInvoices.SalesInvoiceTypeID, SalesInvoiceTypes.Name AS SalesInvoiceTypeName, Customers.Name AS CustomerName, Customers.AddressNo, EntireTerritories.EntireName AS EntireTerritoryEntireName, SalesInvoices.Damages, SalesInvoices.Causes, SalesInvoices.Solutions, " + "\r\n";
            ...
            queryString = queryString + "                       Employees ON SalesInvoices.EmployeeID = Employees.EmployeeID INNER JOIN " + "\r\n";
            queryString = queryString + "                       AspNetUsers ON SalesInvoices.PreparedPersonID = AspNetUsers.UserID INNER JOIN " + "\r\n";
