...
namespace MVCData.Helpers.SqlProgrammability.SalesTasks
{
    class AccountInvoice
    {
        ...
        private void GetPendingSalesInvoices()
        {
            ...
            queryString = " @AspUserID nvarchar(128), @LocationID Int, @AccountInvoiceID Int, @CommodityTypeID Int, @FromDate DateTime, @ToDate DateTime, @SalesInvoiceDetailIDs varchar(3999) " + "\r\n";
            queryString = queryString + " WITH ENCRYPTION " + "\r\n";
            queryString = queryString + " AS " + "\r\n";
            queryString = queryString + "    BEGIN " + "\r\n";
